...
//           {selectedRow && (
//             <Box sx={{ mt: 2 }}>
//               {/* <Typography><strong>ID:</strong> {selectedRow.nextfollowup_id}</Typography> */}
//               {/* <Typography><strong>Follow-up Date:</strong> {selectedRow.nextfollowup_dt}</Typography> */}
//               <Typography><strong>Follow-up Time:</strong> {selectedRow.nextfollowup_at}</Typography>
//               <Typography sx={{ whiteSpace: 'pre-wrap' }}>
//                 <strong>Note:</strong> {selectedRow.note}
//               </Typography>
//               <Typography><strong>Created Date:</strong> {selectedRow.create_dt}</Typography>
//               <Typography><strong>Created Time:</strong> {selectedRow.create_at}</Typography>
//               <Typography><strong>Customer Name:</strong> {selectedRow.customer_name}</Typography>
//               <Typography><strong>Customer Mobile:</strong> {selectedRow.customer_mobile}</Typography>
//               <Typography><strong>Customer City:</strong> {selectedRow.customer_city}</Typography>
//               <Typography><strong>Agent Username:</strong> {selectedRow.agent_username}</Typography>
//               <Typography><strong>Status:</strong> {selectedRow.status_name}</Typography>
//             </Box>
//           )}
